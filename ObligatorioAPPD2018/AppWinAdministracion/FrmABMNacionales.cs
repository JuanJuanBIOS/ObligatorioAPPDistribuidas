...
namespace AppWinAdministracion
{
    public partial class FrmABMNacionales : Form
    {
        ...
        private void TBNumero_Validating(object sender, CancelEventArgs e)
        {
            try
            {
                Nacionales _unNacional = null;

                _unNacional = (Nacionales)new AppWinAdministracion.WSTerminalRef.WSTerminal().Buscar_Viaje(Convert.ToInt32(TBNumero.Text));
